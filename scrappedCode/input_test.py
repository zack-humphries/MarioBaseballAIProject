...
from inputs import Trigger
from inputs import Stick
...
class PadTest(unittest.TestCase):
    def setUp(self):
        ...
        self.pad = inputs.Pad(self.fifo_path)
        self.pad.__enter__()
